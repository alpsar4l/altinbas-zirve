...
export function PremiumIconWithColors() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <linearGradient
                ...
                spreadMethod="pad"
            >
                <stop offset="0%" stopColor="#4dbbff" stopOpacity="1" />
                <stop offset="100%" stopColor="#dd63ff" stopOpacity="1" />
            </linearGradient>
...
export function BookmarksIconOutline() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g data-name="Layer 2">
...
export function BookmarksIconFilled() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g data-name="Layer 2">
                <g data-name="bookmark">
